Circuit Challenge 5 – The Night Light Company
...
This circuit uses an LDR (Light Dependent Resistor) to control an LED.
When light intensity changes, the resistance of the LDR changes, which affects the voltage and turns the LED ON or OFF.
